export const mediaAssets = {
  heroVideo: {
    primary: '/mall-video.mp4',
    secondary: '/mall-video.mp4',
    fallback: '/mall-video.mp4',
    poster: '/mall-video.mp4',
  },
  videos: {
    mainIntro: '/mall-video.mp4',
  ...
  eventShowcase: [
    ...
    'https://images.unsplash.com/photo-1511578314322-379afb476865?w=900&q=85',
  ]
};
